...
class EarthquakePredictionPage_U extends StatefulWidget {
  const EarthquakePredictionPage_U({super.key});
...
class _EarthquakePredictionPageState extends State<EarthquakePredictionPage_U> {
  ...
  final String apiUrl = 'http://192.168.50.190:8000/predicte';
        ...
        if (response.statusCode == 200) {
          ...
          if (username != null) {
            await DatabaseHelper.instance.insertPrediction(
                username!, 'Earth quake Prediction', prediction);
          }
