...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  Future<void> verifyUsername(String username) async {
    final response = await http.get(Uri.parse(
        'http://192.168.50.190:8000/verify-username?username=$username'));
  ...
  Future<void> updatePassword(String username, String newPassword) async {
    final response = await http.post(
      Uri.parse('http://192.168.50.190:8000/update-password'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        height:
            double.infinity, // Ensures the container spans the entire screen
        ...
        child: Padding(
          padding:
              const EdgeInsets.only(top: 100.0), // Small gap from top margin
          child: SingleChildScrollView(
            // Make it scrollable in case of smaller screens
            child: Column(
              mainAxisAlignment:
                            ...
                            ElevatedButton(
                              onPressed: () {
                                if (newPasswordController.text ==
                                  ...
                                  updatePassword(usernameController.text,
