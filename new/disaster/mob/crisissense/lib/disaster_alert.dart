...
class _AdminDisasterInfoPageState extends State<AdminDisasterInfoPage> {
  ...
  Future<void> _submitDisasterAlert() async {
    if (disasterType != null &&
        ...
        affectedLocation.isNotEmpty) {
      try {
        final response = await http.post(
          Uri.parse('http://192.168.50.190:8000/share_alert'),
        ...
        if (response.statusCode == 201) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Alert shared successfully')));
        } else {
          // Handle error response from backend
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text('Failed to share alert')));
        }
      } catch (e) {
        // Handle network or other errors
        print('Error submitting disaster alert: $e');
        ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text('Error occurred while submitting alert')));
      }
    } else {
            ...
            children: <Widget>[
              DrawerHeader(
                ...
                padding: const EdgeInsets.only(
                    top: 5), // Top padding for "Menu" text
                child: Column(
              ...
              child: Padding(
                ...
                child: Center(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment:
                        CrossAxisAlignment.center, // Ensure content is centered
                    children: [
                      ...
                      TextField(
                        ...
                        maxLines:
                            3, // Control the height of the description field
                        decoration: const InputDecoration(
