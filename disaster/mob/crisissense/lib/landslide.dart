...
class LandslidePredictionPage extends StatefulWidget {
  const LandslidePredictionPage({super.key});

  @override
  _LandslidePredictionState createState() => _LandslidePredictionState();
}

class _LandslidePredictionState extends State<LandslidePredictionPage> {
...
Future<void> loadUsername() async {
  ...
  final String apiUrl = 'http://192.168.225.190:8000/predictl'; 
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInputField(PrecipitationController, 'Precipitation'),
