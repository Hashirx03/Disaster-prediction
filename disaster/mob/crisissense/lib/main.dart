...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> loginUser(BuildContext context) async {
    ...
    try {
      final uri = Uri.parse('http://192.168.225.190:8000/login'); 
...
class RegisterPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   ...
   Future<void> registerUser(BuildContext context) async {
    ...
    try {
      final uri = Uri.parse('http://192.168.225.190:8000/register');
      ...
      if (response.statusCode == 201) {
        ...
        Navigator.of(context).pushReplacementNamed('/login'); // Replace with your login page route
      ...
      Navigator.of(context).pop(); // Close the loading indicator in case of error
      ScaffoldMessenger.of(context).showSnackBar(
