...
class CyclonePredictionPage_U extends StatefulWidget {
  const CyclonePredictionPage_U({super.key});

  @override
  _CyclonePredictionPageState createState() => _CyclonePredictionPageState();
}

class _CyclonePredictionPageState extends State<CyclonePredictionPage_U> {
  ...
  final TextEditingController moderateWindNEController = TextEditingController();
  final TextEditingController moderateWindSEController = TextEditingController();
  final TextEditingController moderateWindNWController = TextEditingController();
  String? username;
  String? email;
  String? role;
...
Future<void> loadUsername() async {
  ...
  final String apiUrl = 'http://192.168.225.190:8000/predictc'; 
  ...
  if (_formKey.currentState!.validate()) {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (username != null) {
          await DatabaseHelper.instance.insertPrediction(username!, 'Cyclone Prediction', prediction);
        }
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildInputField(moderateWindNEController, 'Moderate Wind NE'),
                          _buildInputField(moderateWindSEController, 'Moderate Wind SE'),
                          _buildInputField(moderateWindNWController, 'Moderate Wind NW'),
                          const SizedBox(height: 20),
                          ElevatedButton(
